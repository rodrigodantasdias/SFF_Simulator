...
MODELREF_LINK_RSPFILE     = Propulsor_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Propulsor_msf.mexw64
...
SRCS = $(START_DIR)/slprj/sim/Propulsor/Propulsor_msf.c $(MATLAB_ROOT)/extern/version/c_mexapi_version.c
...
OBJS = Propulsor_msf.obj c_mexapi_version.obj
...
Propulsor_msf.obj : $(START_DIR)/slprj/sim/Propulsor/Propulsor_msf.c
	$(CC) $(CFLAGS) -o "$@" "$<"
