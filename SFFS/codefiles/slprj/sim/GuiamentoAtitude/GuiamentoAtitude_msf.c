...
#define S_FUNCTION_NAME GuiamentoAtitude_msf
#endif
...
real_T rtP_Re ; const char * rt_GetMatSignalLoggingFileName ( void ) { return
...
& ( rtP_Re ) , GlobalPrm_0 , sizeof ( real_T ) ) ; } }
#endif
static void mdlInitializeConditions ( SimStruct * S ) { ljgbgmm0igs * dw = (
ljgbgmm0igs * ) ssGetDWork ( S , 0 ) ; real_T * o_o_o_o_B_2_3 = ( real_T * )
ssGetOutputPortSignal ( S , 2 ) ; mxbe4jbwo5 ( o_o_o_o_B_2_3 ) ; } static
void mdlReset ( SimStruct * S ) { ljgbgmm0igs * dw = ( ljgbgmm0igs * )
ssGetDWork ( S , 0 ) ; real_T * o_o_o_o_B_2_3 = ( real_T * )
ssGetOutputPortSignal ( S , 2 ) ; dmf4dhpwtc ( o_o_o_o_B_2_3 ) ; } static
void mdlPeriodicOutputUpdate ( SimStruct * S , int_T tid ) { ljgbgmm0igs * dw
= ( ljgbgmm0igs * ) ssGetDWork ( S , 0 ) ; real_T const * i_pcmcfumtej = (
real_T * ) ssGetInputPortSignal ( S , 0 ) ; real_T const * i_ifvoypvfyr = (
real_T * ) ssGetInputPortSignal ( S , 1 ) ; real_T const * i_kqp5cyqui3 = (
real_T * ) ssGetInputPortSignal ( S , 2 ) ; real_T const * i_pfplfbu0i3 = (
real_T * ) ssGetInputPortSignal ( S , 3 ) ; real_T const * i_cvjctwdaxc = (
real_T * ) ssGetInputPortSignal ( S , 4 ) ; real_T const * i_kbw2pyzhat = (
real_T * ) ssGetInputPortSignal ( S , 5 ) ; real_T * o_B_2_1 = ( real_T * )
ssGetOutputPortSignal ( S , 0 ) ; real_T * o_B_2_2 = ( real_T * )
ssGetOutputPortSignal ( S , 1 ) ; real_T * o_o_o_o_B_2_3 = ( real_T * )
ssGetOutputPortSignal ( S , 2 ) ; if ( tid == 0 ) { GuiamentoAtitude (
i_pcmcfumtej , i_ifvoypvfyr , i_kqp5cyqui3 , i_pfplfbu0i3 , i_cvjctwdaxc ,
i_kbw2pyzhat , o_B_2_1 , o_B_2_2 , o_o_o_o_B_2_3 ) ; } } static void
...
slmrInitializeIOPortDataVectors ( S , 6 , 3 ) ; if ( ! ssSetNumInputPorts ( S
, 6 ) ) return ; if ( ! ssSetInputPortMatrixDimensions ( S , 0 , 3 , 3 ) )
...
mr_GuiamentoAtitude_RegisterSimStateChecksum ( S ) ; ssSetNumSampleTimes ( S
...
mr_GuiamentoAtitude_MdlInfoRegFcn ( S , "GuiamentoAtitude" , & retVal ) ; if
( ! retVal ) return ; }
#endif
#if SS_SFCN_FOR_SIM
if ( ssSetNumDWork ( S , 1 ) ) { int mdlrefDWTypeId ; ssRegMdlRefDWorkType (
S , & mdlrefDWTypeId ) ; if ( mdlrefDWTypeId == INVALID_DTYPE_ID ) return ;
if ( ! ssSetDataTypeSize ( S , mdlrefDWTypeId , sizeof ( ljgbgmm0igs ) ) )
...
static void mdlSetupRuntimeResources ( SimStruct * S ) { ljgbgmm0igs * dw = (
ljgbgmm0igs * ) ssGetDWork ( S , 0 ) ; real_T * o_o_o_o_B_2_3 = ( real_T * )
ssGetOutputPortSignal ( S , 2 ) ; void * sysRanPtr = ( NULL ) ; int sysTid =
0 ; ssGetContextSysRanBCPtr ( S , & sysRanPtr ) ; ssGetContextSysTid ( S , &
sysTid ) ; if ( sysTid == CONSTANT_TID ) { sysTid = 0 ; } i3xwcayboo ( S ,
slmrGetTopTidFromMdlRefChildTid ( S , 0 , false ) , & ( dw -> rtm ) ,
...
genericFcn ; } }
#define MDL_START
static void mdlStart ( SimStruct * S ) { ljgbgmm0igs * dw = ( ljgbgmm0igs * )
ssGetDWork ( S , 0 ) ; real_T * o_o_o_o_B_2_3 = ( real_T * )
ssGetOutputPortSignal ( S , 2 ) ; mdlProcessParameters ( S ) ; ndn1cpexdm (
o_o_o_o_B_2_3 ) ; } static void mdlOutputs ( SimStruct * S , int_T tid ) {
ljgbgmm0igs * dw = ( ljgbgmm0igs * ) ssGetDWork ( S , 0 ) ; real_T const *
i_pcmcfumtej = ( real_T * ) ssGetInputPortSignal ( S , 0 ) ; real_T const *
i_ifvoypvfyr = ( real_T * ) ssGetInputPortSignal ( S , 1 ) ; real_T const *
i_kqp5cyqui3 = ( real_T * ) ssGetInputPortSignal ( S , 2 ) ; real_T const *
i_pfplfbu0i3 = ( real_T * ) ssGetInputPortSignal ( S , 3 ) ; real_T const *
i_cvjctwdaxc = ( real_T * ) ssGetInputPortSignal ( S , 4 ) ; real_T const *
i_kbw2pyzhat = ( real_T * ) ssGetInputPortSignal ( S , 5 ) ; real_T * o_B_2_1
= ( real_T * ) ssGetOutputPortSignal ( S , 0 ) ; real_T * o_B_2_2 = ( real_T
* ) ssGetOutputPortSignal ( S , 1 ) ; real_T * o_o_o_o_B_2_3 = ( real_T * )
ssGetOutputPortSignal ( S , 2 ) ; if ( tid != CONSTANT_TID && tid !=
PARAMETER_TUNING_TID ) { GuiamentoAtitude ( i_pcmcfumtej , i_ifvoypvfyr ,
i_kqp5cyqui3 , i_pfplfbu0i3 , i_cvjctwdaxc , i_kbw2pyzhat , o_B_2_1 , o_B_2_2
, o_o_o_o_B_2_3 ) ; } } static void mdlTerminate ( SimStruct * S ) {
ljgbgmm0igs * dw = ( ljgbgmm0igs * ) ssGetDWork ( S , 0 ) ; absjvhvs1i ( & (
dw -> rtm ) ) ; return ; }
...
mdlrefDW = mr_GuiamentoAtitude_GetDWork ( ssGetDWork ( S , 0 ) ) ;
mxSetFieldByNumber ( ss , 0 , 1 , mdlrefDW ) ; } { mxArray * data =
mr_GuiamentoAtitude_GetSimStateDisallowedBlocks ( ) ; mxSetFieldByNumber ( ss
...
mr_GuiamentoAtitude_SetDWork ( ssGetDWork ( S , 0 ) , mxGetFieldByNumber ( ss
