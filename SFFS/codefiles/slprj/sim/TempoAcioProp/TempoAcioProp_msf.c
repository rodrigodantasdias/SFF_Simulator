...
#define S_FUNCTION_NAME TempoAcioProp_msf
#endif
...
hunxlyfe3u3 * dw = ( hunxlyfe3u3 * ) ssGetDWork ( S , 0 ) ; real_T const *
i_odpvpayxge = ( real_T * ) ssGetInputPortSignal ( S , 0 ) ; real_T const *
i_kaergtdahw = ( real_T * ) ssGetInputPortSignal ( S , 1 ) ; real_T const *
i_pe0uorxc1y = ( real_T * ) ssGetInputPortSignal ( S , 2 ) ; real_T const *
i_m4we4c3ta3 = ( real_T * ) ssGetInputPortSignal ( S , 3 ) ; real_T * o_B_2_1
= ( real_T * ) ssGetOutputPortSignal ( S , 0 ) ; if ( tid == 0 ) {
TempoAcioProp ( i_odpvpayxge , i_kaergtdahw , i_pe0uorxc1y , i_m4we4c3ta3 ,
o_B_2_1 ) ; } } static void mdlInitializeSizes ( SimStruct * S ) { if ( ( S
...
ssSetOutputPortMatrixDimensions ( S , 0 , 12 , 1 ) ) return ;
...
mr_TempoAcioProp_RegisterSimStateChecksum ( S ) ; ssSetNumSampleTimes ( S ,
...
mr_TempoAcioProp_MdlInfoRegFcn ( S , "TempoAcioProp" , & retVal ) ; if ( !
retVal ) return ; }
#endif
#if SS_SFCN_FOR_SIM
if ( ssSetNumDWork ( S , 1 ) ) { int mdlrefDWTypeId ; ssRegMdlRefDWorkType (
S , & mdlrefDWTypeId ) ; if ( mdlrefDWTypeId == INVALID_DTYPE_ID ) return ;
if ( ! ssSetDataTypeSize ( S , mdlrefDWTypeId , sizeof ( hunxlyfe3u3 ) ) )
...
static void mdlSetupRuntimeResources ( SimStruct * S ) { hunxlyfe3u3 * dw = (
hunxlyfe3u3 * ) ssGetDWork ( S , 0 ) ; void * sysRanPtr = ( NULL ) ; int
sysTid = 0 ; ssGetContextSysRanBCPtr ( S , & sysRanPtr ) ; ssGetContextSysTid
( S , & sysTid ) ; if ( sysTid == CONSTANT_TID ) { sysTid = 0 ; } bx1fqdjqke
...
* S , int_T tid ) { hunxlyfe3u3 * dw = ( hunxlyfe3u3 * ) ssGetDWork ( S , 0 )
; real_T const * i_odpvpayxge = ( real_T * ) ssGetInputPortSignal ( S , 0 ) ;
real_T const * i_kaergtdahw = ( real_T * ) ssGetInputPortSignal ( S , 1 ) ;
real_T const * i_pe0uorxc1y = ( real_T * ) ssGetInputPortSignal ( S , 2 ) ;
real_T const * i_m4we4c3ta3 = ( real_T * ) ssGetInputPortSignal ( S , 3 ) ;
real_T * o_B_2_1 = ( real_T * ) ssGetOutputPortSignal ( S , 0 ) ; if ( tid !=
CONSTANT_TID && tid != PARAMETER_TUNING_TID ) { TempoAcioProp ( i_odpvpayxge
, i_kaergtdahw , i_pe0uorxc1y , i_m4we4c3ta3 , o_B_2_1 ) ; } } static void
mdlTerminate ( SimStruct * S ) { hunxlyfe3u3 * dw = ( hunxlyfe3u3 * )
ssGetDWork ( S , 0 ) ; hss3zorcta ( & ( dw -> rtm ) ) ; return ; }
...
mdlrefDW = mr_TempoAcioProp_GetDWork ( ssGetDWork ( S , 0 ) ) ;
mxSetFieldByNumber ( ss , 0 , 1 , mdlrefDW ) ; } { mxArray * data =
mr_TempoAcioProp_GetSimStateDisallowedBlocks ( ) ; mxSetFieldByNumber ( ss ,
...
mr_TempoAcioProp_SetDWork ( ssGetDWork ( S , 0 ) , mxGetFieldByNumber ( ss ,
