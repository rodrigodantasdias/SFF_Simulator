...
## Generated on : Sun Jun 16 15:51:34 2024
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/TempoAcioProp_msf.mexw64
...
MODELREF_LINK_RSPFILE     = TempoAcioProp_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/TempoAcioProp_msf.mexw64
...
SRCS = $(START_DIR)/slprj/sim/TempoAcioProp/TempoAcioProp_msf.c $(MATLAB_ROOT)/extern/version/c_mexapi_version.c
...
OBJS = TempoAcioProp_msf.obj c_mexapi_version.obj
...
MODELREF_LIBS = C:/Users/rodri/OneDrive/Mestrado_ITA/Dissertacao/Dissertacao_Rodrigo_Dias/SFFS/codefiles/slprj/sim/TempoAcioProp/TempoAcioProplib.lib
...
TempoAcioProp_msf.obj : $(START_DIR)/slprj/sim/TempoAcioProp/TempoAcioProp_msf.c
	$(CC) $(CFLAGS) -o "$@" "$<"
