...
## Generated on : Sun Jun 16 15:51:21 2024
## Final product: ./Propulsorlib.lib
...
COMPILER_COMMAND_FILE     = Propulsor_comp.rsp
CMD_FILE                  = Propulsor.rsp
C_STANDARD_OPTS           = -fwrapv
CPP_STANDARD_OPTS         = -fwrapv
MODELLIB                  = Propulsorlib.lib
...
DEFINES_STANDARD = -DMODEL=Propulsor -DNUMST=2 -DNCSTATES=1 -DHAVESTDIO -DMDL_REF_SIM_TGT=1 -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/slprj/sim/Propulsor/Propulsor.c $(START_DIR)/slprj/sim/Propulsor/Propulsor_capi.c
...
OBJS = Propulsor.obj Propulsor_capi.obj
...
%.obj : $(START_DIR)/slprj/sim/Propulsor/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/sim/Propulsor/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/sim/Propulsor/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/sim/Propulsor/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/sim/Propulsor/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
Propulsor.obj : $(START_DIR)/slprj/sim/Propulsor/Propulsor.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Propulsor_capi.obj : $(START_DIR)/slprj/sim/Propulsor/Propulsor_capi.c
	$(CC) $(CFLAGS) -o "$@" "$<"
